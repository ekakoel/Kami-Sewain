        ...
        <section class="row row--grid">
            ...
            <div class="col-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item breadcrumb-item--active">{{ $car_name }} </li>
                </ul>
            </div>
            <!-- end breadcrumb -->
            ...
            <div class="col-12 col-lg-7">
                <div class="details">
                    <div class="splide splide--details details-slider">
            ...
            <div class="col-12 col-lg-5">
                <div class="offer">
                    <span class="offer-title">Offre</span>
                    <div class="offer-wrap">
                        <span class="offer-price">{{ intval($car->daily_rate) }} FCFA <sub>/ jour</sub></span>
                        @if ($car->available)
                        <a href="#" class="offer-rent open-modal" id="rent-btn"><span>Louer</span></a>
                        @else
                        <p style="margin-right: 10px">InAvailable</p>
                        @endif
                    </div>

                    <span class="offer-title">Termes du contrat</span>
                    <form id='rent-form' class="offer-list" action="{{ route('rent.store', ['id' => $car->id]) }}" method="post">
                        @csrf
                        <ul class="offer-list">
                            <li>
                                <span class="offer-list-name">Jour de début </span>
                                <div class="sign-group">
                                    <input type="date" id="start_date" name="start_date" class="sign-input" required min="{{ now()->format('Y-m-d') }}">
                                </div>
                            </li>
                            <li>
                                <span class="offer-list-name">Jour de fin </span>
                                <div class="sign-group">
                                    <input type="date" id="end_date" name="end_date" class="sign-input" placeholder="Jour de retour" required>
                                </div>
                            </li>
                            <li>
                                <span class="offer-list-name">Payment Method </span>
                                <div class="sign-group">
                                    <ul class="sign-radio">
                                        <li>
                    ...
                    <span class="offer-title">Détails de la car</span>
