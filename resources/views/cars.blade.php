...
<div class="container">
    <div class="row row--grid">
        ...
        <div class="col-12">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item breadcrumb-item--active">car</li>
            </ul>
        </div>
        <!-- end breadcrumb -->
        ...
        <div class="col-12">
            <div class="main-filter">
                <form action="{{ route('car.index') }}" action="get" class="main-filter-search">
                ...
                <div class="main-filter-wrap">
                    <select class="main-select" name="make_tmp">
                        <option value="tout">Tout</option>
                        <option value="nouveau">Nouveau</option>
                        <option value="ancien">Ancien</option>
                    </select>

                    <select class="main-select" name="brand">
                        <option value="tout">Toute Brand</option>
    ...
    <div class="row row--grid">
        <div class="col-12">
            <div class="paginator">
                <span class="paginator-pages">6 from 129</span>
