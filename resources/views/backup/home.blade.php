        ...
        <div id="services" class="section-container" data-bs-ride="carousel">
            ...
            <div class="service-inner">
                @foreach ($categories as $category)
                    ...
                    <div id="productModal{{ $category->id }}" class="product-modal">
            ...
            <div class="product-container">
                @foreach ($popularProducts as $index => $popular_product)
                    <div class="card card-fade-in card-fade-in-{{ $index + 1 }}">
                        <div class="card-img" onclick="openModal({{ $popular_product->name }})">
                    ...
                    <div id="productModal{{ $popular_product->name }}" class="product-modal">
                        <div class="product-modal-content">
                            <button class="modal-close-btn" onclick="closeModal({{ $popular_product->name }})">&times;</button>
                            <div class="product-modal-body">
                                <div class="product-image-section">
                                    <div class="product-large-image">
                                    ...
                                    <div class="product-thumbnails">
                                        @foreach ($popular_product->secondaryImages as $thumbnail)
                                            <img src="{{ asset('/images/product/chair/'.$thumbnail->url) }}" alt="{{ $thumbnail->alt }}" class="product-thumbnail" onclick="changeImage({{ $popular_product->id }}, '{{ asset('/images/product/chair/'.$thumbnail->url) }}',this)">
                                        @endforeach
                                    </div>
                                </div>
                                <div class="product-details-section">
        ...
        <div class="section-container bg-light">
            <div class="promotion-container">
                <div class="promotion-item active">
                    <div class="promotion-title">"Special Promotion"</div>
                    <div class="promotion-content">"dapatkan promo menarik di bulan September"</div>
                    <div class="promotion-footer"><button class="btn button-primary">Get the promo</button></div>
                </div>
                <div class="promotion-item">
                    <div class="promotion-title">"Discount 2%"</div>
                    <div class="promotion-content">"dapatkan potongan harga menarik di bulan September"</div>
                    <div class="promotion-footer"><button class="btn button-primary">Get the promo</button></div>
                </div>
                <div class="promotion-item">
                    <div class="promotion-title">"Boom Discount 2% + 3%"</div>
                    <div class="promotion-content">"dapatkan potongan harga hingga 5% di bulan September"</div>
                    <div class="promotion-footer"><button class="btn button-primary">Get the promo</button></div>
                </div>
            </div>
            <!-- Navigation buttons -->
