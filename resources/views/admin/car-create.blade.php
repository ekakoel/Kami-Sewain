            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.car.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="brand" class="col-sm-3 my-2 col-form-label">Brand :</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="brand" name="brand" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="year" class="col-sm-3 my-2 col-form-label">Year of manufacture :</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="year" name="make_year" min="1900" max="{{ date('Y') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="seats" class="col-sm-3 my-2 col-form-label">Number of seats :</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="seats" name="passenger_capacity" min="1" max="50" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="km_per_litre" class="col-sm-3 my-2 col-form-label">Mileage per liter :</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="km_per_litre" name="kilometers_per_liter" step="0.01" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fuel_type" class="col-sm-3 my-2 col-form-label">Fuel type :</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="transmission_type" class="col-sm-3 my-2 col-form-label">Transmission type :</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="rental_price" class="col-sm-3 my-2 col-form-label">Rental price per day :</label>
                        ...
                        <div class="form-group row">
                            <label for="main_image" class="col-sm-3 my-2 col-form-label">Main image :</label>
                            <div class="col-sm-9">
                                <input type="file" class="form-control-file" id="main_image" name="main_image" accept="image/*" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="secondary_images" class="col-sm-3 my-2 col-form-label">Secondary images (3 max) :</label>
                            <div class="col-sm-9">
