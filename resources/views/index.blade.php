...
@section('main')
      ...
      <div class="row">
        <div class="col-12">
          <div class="home-content">
            <h1 class="home-title">La location, <br>encore plus facile</h1>
            <p class="home-text">The best place to rent a car easily!</p>

            <form class="home-search" action="{{ route('car.index') }}" method="get">
              <div class="home-group">
                <label for="Brand">Brand</label>
                <input type="text" name="brand" id="Brand" placeholder="What Brand are you looking for?" required>
              </div>
              
              <div class="home-group">
                <label for="model">Model</label>
                <input type="text" name="model" id="model" placeholder="Which model do you want?" required>
              </div>

              <div class="home-group">
                <label for="max_daily_rate">Prix journalier max</label>
                <input type="text" name="max_daily_rate" id="max_daily_rate" placeholder="Price in FCFA" required>
              </div>
  ...
  <div class="container">
    ...
    <section class="row row--grid">
      <!-- title -->
      <div class="col-12">
        <div class="main-title main-title--first">
          <h2>Nos car</h2>

          <a href="{{ route('car.index') }}" class="main-link">More Detail<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div class="col-12 col-md-6 col-xl-4">
        <div class="car">
          <div class="splide splide--card car-slider">
            <div class="splide-arrows">
              <button class="splide-arrow splide-arrow--prev" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <button class="splide-arrow splide-arrow--next" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <div class="car-title">
            <h3 class="car-name"><a href="car.html">{{ $car->brand.' '.$car->model }}</a></h3>
            <span class="car-year">{{ $car->make_year }}</span>
          </div>
          <ul class="car-list">
            <li>
          ...
          <div class="car-footer">
            <span class="car-price">{{ intval($car->daily_rate) }} FCFA <sub>/ jour</sub></span>
            
            <a href="{{ route('car.show', ['id' => $car->id]) }}" class="car-more"><span>Details</span></a>
          </div>
        </div>
      </div>
      <!-- end car -->
    ...
    <section class="row row--grid">
      ...
      <div class="col-12 col-md-6 col-xl-4">
        <div class="step1">
          <span class="step1-icon step1-icon--pink">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <h3 class="step1-title">Créez un profil</h3>
          @auth
            <p class="step1-text">Vous avez un compte ? Parfait, visitez notre parking<br><a href="{{ route('car.index') }}">car</a></p>
          @endauth
          @guest
            <p class="step1-text">Pour faire une location, vous devez Create un compte<br><a href="{{ route('register.show') }}">Commencer</a></p>
          @endguest
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-xl-4">
        <div class="step1">
          ...
          <h3 class="step1-title">Dîtes nous quelle voiture vous désirez</h3>
          <p class="step1-text">Nous avons une gamme assez complète de véhicule à mettre à votre disposition</p>
        </div>
      </div>

      <div class="col-12 col-md-6 col-xl-4">
        <div class="step1">
          <span class="step1-icon step1-icon--purple">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <h3 class="step1-title">Validez un contrat</h3>
          <p class="step1-text">Confirmez vos contrat de location et venez récuper votre véhicule</p>
        </div>
      </div>
    </section>
    <!-- end get started -->
