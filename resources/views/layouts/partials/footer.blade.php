      ...
      <div class="row">
        <div class="col-md-6">
          <div class="logo color-primary">
            <img src="/logo/logo-kami-sewain-caption-color.png" alt="Logo Kami Sewain">
          </div>
          <br>
          <br>
        ...
        <div class="col-md-2">
          ...
          <ul>
            ...
            <li class="footer-li">
              <div class="footer-link">
                <a href="{{ route('contacts.index') }}">FAQs</a>
              </div>
            </li>
            <li class="footer-li">
              <div class="footer-link">
                <a href="{{ route('contacts.index') }}">Product</a>
              </div>
            </li>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-12 text-center m-t-b-18">
        ...
        <div class="col-md-12 text-center m-b-18"><small class="footer-copyright">© Kami Sewain, 2024</small></div>
        {{-- <div class="col-12">
          <div class="footer-content">
          <div class="footer-logo color-primary">
            Kami Sewain
          </div>
            ...
            <small class="footer-copyright">© Kami Sewain, 2024</small>
          </div>
        </div> --}}
      </div>
    </div>
