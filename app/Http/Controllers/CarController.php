...
class CarController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Filtre par Year of manufacture
    ...
    {
        // Récupérer les Data validées
        $validatedData = $request->validated();

        // Récupérer le fichier d'Main image
        $mainImage = $request->file('main_image');

        // Enregistrer la voiture dans la base de Data
        $car = new Car();
        ...
        // Enregistrer les images secondaires dans la base de Data
    ...
    {
        // Récupérer la voiture à Delete
        $car = Car::findOrFail($id);

        // Delete l'Main image de la voiture
        Storage::disk('public')->delete($car->image_url);

        // Delete les images secondaires de la voiture
        foreach ($car->secondaryImages as $image) {
            Storage::disk('public')->delete($image->url);
            $image->delete();
        }

        // Delete la voiture de la base de Data
        $car->delete();
